...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 30, 2017 at 09:07 AM
...
CREATE TABLE `categories` (
  ...
  `in_out` varchar(3) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(3, '2016-01-25 21:46:15', 13, 121, 'exp', 5, 'luposti', 0, 26),
...
(15, '2017-08-25 21:13:30', 11, 274, 'inc', 3, 'drugi2 pari', 0, 26),
(16, '2017-09-25 21:20:44', 11, 129, 'inc', 1, ' gluposti', 0, 26),
(17, '2017-10-25 21:21:43', 11, 1210, 'inc', 1, 'pari', 0, 26),
...
(28, '2017-10-29 12:14:46', 35, 133, 'inc', 15, 'asaaaaa', 1, 26),
...
(39, '2017-04-25 18:46:46', 13, 77, 'inc', 13, 'nonono', 0, 26);
...
(26, 'test30@test.com', 'f6ebefa3fcf47cdc0eb801265d1d2dabcfc4fff6', 'Natest30b', 'F30test30s', '../uploads/26-profile.jpeg', 1, '2017-10-19 13:19:18', 0),
...
--
-- Structure for view `categoriesunion` exported as a table
--
DROP TABLE IF EXISTS `categoriesunion`;
CREATE TABLE`categoriesunion`(
    `category_id` int(11) NOT NULL DEFAULT '0',
    `category_name` varchar(16) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
    `icon_url` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
    `catgory_color` varchar(11) COLLATE utf8_unicode_ci DEFAULT NULL,
    `category_desc` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
    `user_id` int(11) NOT NULL DEFAULT '0'
);
...
ALTER TABLE `transactions`
  ...
  ADD CONSTRAINT `fk_categories` FOREIGN KEY (`category_id`) REFERENCES `categories` (`category_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
