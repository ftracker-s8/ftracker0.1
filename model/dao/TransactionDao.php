...
class TransactionDao {
    ...
    const ADD_EXPENCE = "INSERT INTO transactions (account_id, date_time, `amount`, exp_inc, category_id, user_id, description, recurent_bill, next_update) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
ORDER BY t.date_time DESC";
    ...
    public function addExpence(Transaction $uid){
        ...
        $stm->execute([$uid->getAccountId(), $uid->getDateTime(), $uid->getAmount(), $uid->getExpInc(), $uid->getCategoryId(), $uid->getUserId(), $uid->getDescription(), $uid->getRecurentBill(), $uid->getNextUpdate()]);
